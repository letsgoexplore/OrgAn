...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 8), // int()(char * *, char const *, char const * *, size_t)
/*  1 */ _CFFI_OP(_CFFI_OP_POINTER, 6), // char * *
/*  2 */ _CFFI_OP(_CFFI_OP_POINTER, 7), // char const *
/*  3 */ _CFFI_OP(_CFFI_OP_POINTER, 2), // char const * *
/*  4 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 28), // size_t
/*  5 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  6 */ _CFFI_OP(_CFFI_OP_POINTER, 7), // char *
/*  7 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 2), // char
/*  8 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 7), // int
};

static int _cffi_d_solve(char * * x0, char const * x1, char const * * x2, size_t x3)
{
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_lib_solver(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_lib_solver(void) { return NULL; }
#  else
     initlib_solver(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit_lib_solver(void)
{
  return _cffi_init("lib_solver", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initlib_solver(void)
{
  _cffi_init("lib_solver", 0x2601, &_cffi_type_context);
}
#endif
