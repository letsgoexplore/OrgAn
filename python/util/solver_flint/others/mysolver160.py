...
from charm.toolbox.eccurve import secp256k1, secp128r1, secp160k1
...
#P = 115792089237316195423570985008687907852837564279074904382605163141518161494337  #order of secp256k1 
P = int(group160.order())
#print("P:", P)
...
if __name__ == "__main__":
    ...
    timingfilename = "./tmp/equ_solve_timing_n_"+str(input_length)+".csv"
